<?php
    if(isset($_POST['id_pelanggan'])) {
        ...
        $idTerakhir = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM penjualan ORDER BY id_penjualan DESC LIMIT 1"));
    ...
    <form method="post">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input class="form-control" type="number" step="1" min="0" max="<?php echo $produk['stock']; ?>" name="produk[<?php echo $produk['id_produk']; ?>]">
                </td>
            </tr>
            <?php
                }
